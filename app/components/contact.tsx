...
export default function Contact() {
  return (
    <section
      id="contact"
      className="flex flex-col justify-center items-center min-h-[100vh] text-center"
    >
      <h1 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">
        Contact Me
      </h1>
      <div className="bg-[#f8f8ff] dark:bg-[#1e1e2f] text-gray-900 dark:text-gray-200 gap-4 border border-gray-300 dark:border-gray-700 rounded-lg p-6 sm:p-8 ">
